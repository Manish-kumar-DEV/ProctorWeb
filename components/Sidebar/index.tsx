...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <div
      ref={sidebar}
      className={`absolute bg-white left-0 border-r-2 top-0 z-10 flex h-screen w-72 flex-col overflow-y-hidden duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
